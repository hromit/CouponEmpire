...
import com.offers.couponempire.iabutils.MainActivity_iabhelper;
import com.offers.couponempire.R;
import com.offers.couponempire.ui.BaseActivity;
    ...
    public static class PurchaseDialog extends DialogFragment {
        ...
        public PurchaseDialog(){
            if (mHelper==null && getActivity()!=null)
                mHelper= ((MainActivity_iabhelper)getActivity()).getHelper();
        };
