...
import com.offers.couponempire.fragment.BaseMaterialFragment;
...
*/
    ...
    public static NativeMaterialCardFragment newInstance(String param1, String param2) {
        NativeMaterialCardFragment fragment = new NativeMaterialCardFragment();
    ...
    private void init_largeimage() {
        ...
        MaterialLargeImageCard card =
                MaterialLargeImageCard.with(getActivity())
                        .setTextOverImage("Italian Beaches")
                        .setSubTitle("A classic italian wine")
